...
const MapDefs = {
  ...
  forest: {
    ...
    getSlots(w, h) {
      return [
        {x:w*0.05, y:h*0.56}, {x:w*0.05, y:h*0.84},
        {x:w*0.21, y:h*0.48}, {x:w*0.07, y:h*0.33},
        {x:w*0.26, y:h*0.14}, {x:w*0.45, y:h*0.14},
        {x:w*0.45, y:h*0.50}, {x:w*0.28, y:h*0.64},
        {x:w*0.50, y:h*0.84}, {x:w*0.67, y:h*0.84},
        {x:w*0.69, y:h*0.50}, {x:w*0.53, y:h*0.33},
        {x:w*0.72, y:h*0.14}, {x:w*0.91, y:h*0.14},
        {x:w*0.93, y:h*0.50}, {x:w*0.79, y:h*0.64},
        {x:w*0.95, y:h*0.84}, {x:w*0.93, y:h*0.57},
      ];
    },
  ...
  city: {
    ...
    getSlots(w, h) {
      return [
        // 입구쪽
        {x:w*0.07, y:h*0.32}, {x:w*0.07, y:h*0.68},
        {x:w*0.14, y:h*0.50},
        // 첫번째 꺾임 옆
        {x:w*0.28, y:h*0.12}, {x:w*0.35, y:h*0.35},
        {x:w*0.28, y:h*0.68},
        // 두번째 구간
        {x:w*0.50, y:h*0.12}, {x:w*0.50, y:h*0.55},
        {x:w*0.60, y:h*0.70}, {x:w*0.68, y:h*0.90},
        // 출구쪽
        {x:w*0.88, y:h*0.32}, {x:w*0.88, y:h*0.68},
      ];
    },
